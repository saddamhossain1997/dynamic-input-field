...
<body>
                    ...
                    <tbody id="tbody">
                        <tr id="tRow" class="d-none">
                            ...
                            <td> <label for="input_name">Qty:</label>
                                <input type="text" name="qty[]" onchange="cal(this)" required>
                            </td>
                            <td>
                                <label for="input_value">Price:</label>
                                <input type="text" name="price[]" onchange="cal(this)" required>
                            </td>
                            <td> <label for="input_name">Total:</label>
                                <input type="text" name="totals[]" required>
                            </td>
                            <td>
    ...
    <script>
        function AddBtn() {
            ...
            var clearInput = $(v).find('input').val('');
